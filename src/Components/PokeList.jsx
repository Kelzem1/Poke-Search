        ...
        <div className={`bg-${color} rounded-md h-5/5 box-shadow: 0 25px 50px -12px rgba(0,0,0,0.25); flex-col m-5 p-5 border-2 border-stone-900  transition-all duration-150 `}>
                        ...
                        <div className="flex-col 3/5">
                                ...
                                <div className='flex justify-center w-full h-full m-auto'>
                                    <img className="drop-shadow-2xl shadow-slate-400  transition-all w-40 h-40" src={img} alt={id}></img>
                                </div>
            ...
            <div className="grid grid-row m-auto w-full h-2/4 mt-4">

                <div className='h-1/4 gap-3 grid grid-cols-1 xl:grid-cols-4  align-middle justify-center text-center mb-5 '>

                            <div className=''>
                            <h2  className={statsStyle}> Type: {tipo}</h2>
                            </div>
                            <div className=''>
                                <h2 className={statsStyle}>Ability: {abilities}</h2>
                            </div>
                            <div className=''>
                                <h2  className={statsStyle}>Height: {AltuReal} mtrs</h2>
                            </div>
                            <div className=''>
                                <h2 className={statsStyle}>Weight: {PesoReal} Kgs</h2>
                            </div>
                </div>

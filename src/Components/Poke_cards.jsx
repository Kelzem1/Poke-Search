const PokeCard = ({title, id, img, name, tipo, height, weight, abilities, hp, attack, defense, specialAttack, specialDefense, speed}) =>{
    return(
        <div className="flex-col justify-center align-middle bg-card-black opacity-90 w-72 h-full rounded">
            <div className="flex-col m-10 justify-center align-middle">
                ...
                <span className="text-yellow-50">Type: {tipo}</span>
            </div>

            <div className="text-yellow-50 p-3 flex-col flex-nowrap">
